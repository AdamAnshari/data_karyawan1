...
<?php
	if (isset($_POST['edit'])) {
		...
		$email = $_POST['email'];
		$foto = $_POST['foto'];
		$tambah = mysqli_query($koneksi, "UPDATE  data_karyawan SET nama_lengkap='$nama_lengkap',alamat='$alamat',jenis_kelamin='$jenis_kelamin',email='$email',foto='$foto' WHERE id='$id'");
		if ($tambah) {
			?>
